...
| Field | Value |
|---|---|
| Last completed phase | Phase 5 - (see Phase Status) |
| Last successful commit | 398a8f5 |
| Next action | Dispatch phase 6 |
...
Rollup: total=1123438 | phases=6 | median/phase=80429
